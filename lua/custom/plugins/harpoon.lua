return {
  ...
  keys = {
    ...
    { '<C-b>', "<cmd>lua require('harpoon.ui').nav_file(1)<cr>", desc = 'Navigate to 1st harpoon file' }, -- TODO: Switch back to <C-h> if I don't like this, but for now switched so that I can use <C-hjkl> for tmux navigation
